...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= 'You must have to select a area/location.<br>';
    }
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Shipping cost for rest of the area is updated successfully.';
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Select Location/Area <span>*</span></label>
                            <div class="col-sm-4">
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: If a area does not exist in the above list, the following "Rest of the area" shipping cost will be applied upon that.</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Shipping Cost (Rest of the area)</h1>
    </div>
</section>
